...
public class Component {
     ...
     *
     * @param name   The name of the component, e.g. "VEVNET", "VTODO".
     * @param parent Parent component of this component, may be null
     */
     ...
     * implemented, concrete components should have their own implementations.
     *
     * @param eventInfo information queried from database
     * @throws VCalendarException
     */
     ...
     *
     * @param cursor a cursor containing component information, must NOT be null
     * @throws VCalendarException
     */
