...
public abstract class ComponentInfoHelper {
     ...
     * @param type    URI string used to query component information
     ...
     *
     * @param componentCursor cursor containing components
     * @param info            holder of all the information of one single component
