...
import com.koma.vcalendarlibrary.component.VEvent;
import com.koma.vcalendarlibrary.database.DatabaseHelper;
...
import com.koma.vcalendarlibrary.utils.VCalFileReader;
...
public class VCalParser {
     ...
     * "PC Sync"
     *
     * @param srcUri   the srcUri pointing to the data or file preparing to parse.
     ...
     *
     * @param srcUri         the srcUri pointing to the data or file preparing to parse.
     * @param dstAccountName the destination Account name
     * @param context        the context to get resolver
     * @param listener       the call back
     */
     ...
     *
     * @param vcsContent the vcsString
     * @param context    the context to get resolver
     */
