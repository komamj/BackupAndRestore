...
import com.koma.vcalendarlibrary.component.ComponentFactory;
...
public class VCalComposer {
     ...
     * @param selection selection used to query from database
     * @param listener  listener to observe compose process
     */
     ...
     *
     * @param info components information queried from database
