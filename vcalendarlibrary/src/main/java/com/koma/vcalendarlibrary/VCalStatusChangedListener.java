...
public interface VCalStatusChangedListener {
     ...
     *
     * @param successCnt the successful handled count
     ...
     *
     * @param currentCnt current handled count
     * @param totalCnt   total count
     */
     ...
     *
     * @param finishedCnt the count has been finished before the cancel operation
     * @param totalCnt    total count
     */
     ...
     *
     * @param finishedCnt the count has been finished before the exception occurred.
     * @param totalCnt    total count
