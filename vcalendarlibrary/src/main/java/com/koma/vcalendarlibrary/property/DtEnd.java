...
public class DtEnd extends Property {
     ...
     * DtEnd Constructor
     *
     * @param value the DtEnd value string
     */
    ...
    public void writeInfoToContentValues(ContentValues cv)
        ...
        if (Component.VEVENT.equals(mComponent.getName())) {
            cv.put(Events.DTEND, getValueMillis());
        }
    }

    /**
     * Get DtEnd time in millisecond.
     *
     * @return end time in millisecond
     * @throws VCalendarException when parse the DtEnd value String
     */
