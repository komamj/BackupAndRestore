...
import com.koma.vcalendarlibrary.valuetype.Text;
...
public class Property {
     ...
     *
     * @param sb the string builder to appends this property.
     */
     ...
     *
     * @param cv the ContentValues
     * @throws VCalendarException when cv is null
     */
     ...
     *
     * @param cvList the given ContenValues list.
     * @throws VCalendarException the given cvList is null
     */
     ...
     * @param component which component this property is composing for?
     * @throws VCalendarException the cursor is empty or null
     */
