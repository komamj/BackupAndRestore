...
import static com.koma.vcardlibrary.VCardConstants.PROPERTY_BDAY;
    ...
    public VCardBuilder appendEvents(final List<ContentValues> contentValuesList) {
        ...
        if (contentValuesList != null) {
            ...
            if (primaryBirthday != null) {
                appendLineWithCharsetAndQPDetection(PROPERTY_BDAY, primaryBirthday.trim());
            } else if (secondaryBirthday != null) {
                appendLineWithCharsetAndQPDetection(PROPERTY_BDAY,
